...
const AddBlogs = () => {
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 shadow md:p-10 sm:m-10 rounded">
        ...
        <select
          ...
          name="category"
          className="mt-2 px-3 py-2 text-gray-500 border border-gray-300 outline-none"
        >
        ...
        <button
          disabled={isAdding}
          type="submit"
          className="mt-8 w-40 h-10 bg-blue-400 text-white rounded cursor-pointer text-sm"
        >
